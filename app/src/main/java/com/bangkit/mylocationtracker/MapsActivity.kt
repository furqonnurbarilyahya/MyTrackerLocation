package com.bangkit.mylocationtracker
...
import com.bangkit.mylocationtracker.databinding.ActivityMapsBinding
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                for (location in locationResult.locations) {
                    ...
                    val lastLastLng = LatLng(location.latitude, location.longitude)

                    //draw plyline
                    allLatLng.add(lastLastLng)
                    mMap.addPolyline(
                        PolylineOptions()
                            .color(Color.GREEN)
                            .width(10f)
                    ...
                    //set boundaries
                    boundsBuilder.include(lastLastLng)
